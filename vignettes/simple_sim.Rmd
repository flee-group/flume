...
plot(network, edge.arrow.size = 0.5, edge.width = 20, 
  vertex.label.cex = 0.8, vertex.label.color = vlc)
```
...
plot(network, "species", edge.arrow.size = 0, edge.width = 20, vertex.label.cex = 0.7)
```
