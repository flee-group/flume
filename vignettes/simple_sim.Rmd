...
The parameter matrix will need to have named columns corresponding to parameters in the model. Additional parameters that are required for (for example) colonisation and extinction functions should also be provided in this matrix.
