...
All of these except for discharge can be derived from a digital elevation model using the `watershed` package (https://github.com/flee-group/watershed)[https://github.com/flee-group/watershed]. We will use the `kamp` dataset, which is included with that package.
