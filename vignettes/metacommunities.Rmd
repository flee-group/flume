...
Here we generate by hand a metacommunity for algae using N:P ratio. We know little about dispersal,
nor about resource use, so for the moment we use the defaults and focus on defining the niche shape.

If we add names to the location vector, these will be used in the resulting metacommunity for 
plotting and other output.

```{r algae, fig.width = 9, fig.height = 3.5}
# niche locations
niche_loc = matrix(c(200.51879,  200.51879, 139.15023, 18.47656, 414.07093), ncol = 1,
	dimnames = list(c("ASV_4", "ASV_5", "ASV_17", "ASV_63", "ASV_67"), "N:P"))

# niche widths
niche_wid = c(164.629301, 164.629301, 102.373506, 3.765155, 160.079609)
names(niche_wid) = rownames(niche_loc) ## optional
